<template>
  <div>
    ...
    <div v-if="filteredResources.length === 0" class="alert alert-info fs-5">No caregiver resources found.</div>
          ...
          <div class="card-body d-flex flex-column">
            ...
            <div class="d-flex flex-column gap-3">
              ...
              <div class="d-flex align-items-center">
                ...
                <button @click="submitRating(item)" class="btn btn-outline-success btn-sm flex-grow-1">Submit Rating</button>
              </div>
            </div>
          </div>
        </div>
